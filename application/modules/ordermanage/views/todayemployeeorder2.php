<table class="table table-fixed table-bordered table-hover bg-white wpr_100" id="onprocessingEmployee2">
    <thead>
        <tr>
            <th class="text-center"><?php echo display('sl'); ?>. </th>
            <th class="text-center"><?php echo display('invoice'); ?> </th>
            <th class="text-center">Guest's By</th>
...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/todayemployeeorder2.js'); ?>" type="text/javascript"></script>