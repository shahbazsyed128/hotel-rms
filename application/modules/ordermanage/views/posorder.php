    ...
    <div class="panel-body">
      <div class="tabsection"> <span class="display-none"><?php echo $settinginfo->language; ?></span>
        <ul class="nav nav-tabs mb-2" role="tablist">
          ...
          <li> <a href="#employeeorders2" role="tab" data-toggle="tab" class="employeeorder2 newtab" id="todayemployeeorder2" onclick="giveselecttab(this)"><i class="fa fa-first-order smallview"></i> <span class="responsiveview">Items Expenses</span> </a> </li>
