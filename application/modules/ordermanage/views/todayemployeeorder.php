<table class="table table-fixed table-bordered table-hover bg-white wpr_100" id="onprocessingEmployee">
    <thead>
        <tr>
...
<script src="<?php echo base_url('application/modules/ordermanage/assets/js/todayemployeeorder.js'); ?>" type="text/javascript"></script>